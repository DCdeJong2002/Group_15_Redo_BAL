...
modeloff = ModelOffCorrector(
    ...
    save_dir=BASE_DIR / "results_propOn_noModelOff"
)
...
propon.set_save_directory(BASE_DIR / "results_propOn_noModelOff")
...
df_prop_on_wake = propon.apply_wake_blockage(
    fit_csv=BASE_DIR / "results_propOff_noModelOff" / "propOff_CD_fit_parameters.csv",
    save_csv=True,
