...
def run_propon_workflow(
    ...
    recompute_cyaw_for_thrust_sep: bool = False,
...
if __name__ == "__main__":
    propon, df_final, outputs = run_propon_workflow(
        ...
        save_directory="results_propOn_FINAL_NEW"
    )
    ...
    subprocess.run([
        ...
        "--propon",  str(BASE_DIR / "results_propOn_FINAL_NEW" / "propOn_final.csv"),
        "--propoff", str(BASE_DIR / "results_propOff_FINAL"    / "propOff_final.csv"),
        "--out",     str(BASE_DIR / "results_propOn_FINAL_NEW" / "comparison.html"),
    ], check=True)