...
from correction_classes_FINAL import PropOnData, ModelOffCorrector
...
def run_propon_workflow(
    ...
    # Load raw data
    # ------------------------------------------------------------
    prop_on_raw = pd.read_csv(UPPER_DIR / "01_raw_data_correction" / "PROCESSED_TEST_DATA" / "all_rudder_cases_combined.csv")
